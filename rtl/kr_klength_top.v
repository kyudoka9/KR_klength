...
module kr_klength_top #(
    ...
    wire [31:0]             de_speculation_correct;
    wire [31:0]             de_speculation_replays;
    ...
    kr_klength_regs #(
        ...
        // Watchdog status (directly from watchdog module when instantiated;
        // tied off here — watchdog is instantiated separately if needed)
        .wd_timeout_alert  (1'b0),
        .wd_all_complete   (1'b0),
        .wd_missing_count  (32'd0),
        .wd_timeout_tag    (12'd0),
